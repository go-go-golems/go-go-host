...
export function AdminDeploymentDetailPage() {
  ...
  return <div className="admin-deployment-detail-page">
    ...
    <section className="dashboard-panel admin-deployment-detail-page__meta"><h2>Metadata</h2><dl><dt>Organization</dt><dd>{dep.orgName} <code>{dep.orgId}</code></dd><dt>Site</dt><dd>{dep.siteSlug} <code>{dep.siteId}</code></dd><dt>Version</dt><dd>{dep.version}</dd><dt>Created by</dt><dd>{dep.createdByType} <code>{dep.createdById}</code></dd><dt>Created</dt><dd><Timestamp value={dep.createdAt} /></dd><dt>Activated</dt><dd><Timestamp value={dep.activatedAt} /></dd><dt>Bundle</dt><dd><code>{dep.bundleRef || '—'}</code></dd><dt>Bundle SHA256</dt><dd><code>{dep.bundleSha256 || '—'}</code></dd><dt>Unpacked path</dt><dd><code>{dep.unpackedPath || '—'}</code></dd></dl></section>
