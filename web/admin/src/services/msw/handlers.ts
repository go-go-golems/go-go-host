...
export const handlers = [
  ...
  http.post('/api/v1/admin/runtimes/:siteId/restart', ({ params }) => HttpResponse.json({ ...fixtures.runtimeReady, siteId: String(params.siteId), status: 'ready' })),
  http.post('/api/v1/admin/runtimes/:siteId/stop', ({ params }) => HttpResponse.json({ siteId: String(params.siteId), status: 'stopped' })),
