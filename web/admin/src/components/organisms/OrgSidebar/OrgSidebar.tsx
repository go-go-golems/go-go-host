...
export type OrgSection = 'sites' | 'agents' | 'audit' | 'members' | 'usage';
const sections: { id: OrgSection; label: string }[] = [
  { id: 'sites', label: 'Sites' }, { id: 'agents', label: 'Agents' }, { id: 'audit', label: 'Audit' }, { id: 'members', label: 'Members' }, { id: 'usage', label: 'Usage' },
];
