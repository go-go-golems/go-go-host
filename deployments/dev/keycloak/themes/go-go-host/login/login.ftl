    ...
    <#elseif section = "form">
        <div id="kc-form">
          <div id="kc-form-wrapper">
            ...
            <#-- ── Social providers FIRST (prominent, above local login) ── -->
            <#if realm.password && social?? && social.providers?has_content>
                <div id="kc-social-providers">
                    <ul class="kc-social-providers-list">
                        <#list social.providers as p>
                            <li>
                                <a id="social-${p.alias}" class="kc-social-provider-btn" type="button" href="${p.loginUrl}">
                                    <#if p.iconClasses?has_content>
                                        <i class="${p.iconClasses!}" aria-hidden="true"></i>
                                    </#if>
                                    <span class="kc-social-provider-name">${msg("identity-provider-login-label", p.displayName!)}</span>
